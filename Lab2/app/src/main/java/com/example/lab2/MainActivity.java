...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onPause(){ //Activity przykryte
        super.onPause();
    ...
    @Override
    protected void onStop(){ //Activity wstrzymane
        super.onStop();
    ...
    @Override
    protected void onDestroy(){ //Activity zamknięte
        super.onDestroy();
    ...
    @Override
    protected void onRestart(){ //Activity przywrócone po wstrzymaniu
        super.onRestart();
